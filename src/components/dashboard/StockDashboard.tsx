...
import { StockOutlined, RiseOutlined, BarChartOutlined, ProfileOutlined } from '@ant-design/icons';
import {
  LineChart,
  Line,
  XAxis,
    ...
    <div style={{ padding: isMobile ? '12px' : '24px' }}>
      ...
      <Card variant="borderless" style={{ marginBottom: '24px' }}>
        <Row gutter={[24, 16]} align="middle">
          ...
          {/* 右侧 - 投资评级 */}
          <Col xs={24} md={8}>
            <Card title="综合评级" size="small" style={{ textAlign: 'center' }}>
              <Progress
                type="dashboard"
              ...
              <div style={{ height: '400px' }}>
                <ResponsiveContainer width="100%" height="100%">
                  <LineChart data={priceChartData}>
                    ...
                    <YAxis fontSize={isMobile ? 10 : 12} tickFormatter={(value) => `$${value}`} />
              ...
              <div style={{ height: '200px' }}>
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={volumeChartData}>
                    <CartesianGrid strokeDasharray="3 3" />
                    <XAxis dataKey="date" fontSize={isMobile ? 10 : 12} />
                    <YAxis fontSize={isMobile ? 10 : 12} tickFormatter={(value) => `${value}M`} />
                    <Tooltip
                      content={<CustomTooltip />}
                      formatter={(value: number | string) => [`${value}M`, '交易量']}
                    />
                    <Bar dataKey="volume" fill="#1890ff" name="交易量" />
                  </BarChart>
                </ResponsiveContainer>
              </div>
            </Card>
          ...
          >
            ...
            <Card title="公司信息" size="small">
              <Descriptions column={isMobile ? 1 : 2} size="small">
                ...
                <Descriptions.Item label="板块">{stockData.company_info.sector}</Descriptions.Item>
                <Descriptions.Item label="国家">{stockData.company_info.country}</Descriptions.Item>
                <Descriptions.Item label="公司官网">
                  <a
                    href={stockData.company_info.website}
                    target="_blank"
